...
<!-- management -->
Технический директор, директор по разработке в компании среднего размера; руководство департаментом 
...
### [2025..] Руководитель направления // Ozon Tech
1. Вырастил направление с 3 до 5 команд, превратил сайд-продукт одной из команды в проект с видимостью на уровне руководства компании
2. Решил кризис в одной из команд, перестроил оргструктуру подразделения
3. Запустил процесс ревизии архитектуры, подготовил и согласовал с другими командами единые требования к изменению архитектуры платформы логистики для упрощения разработки

### [2020­..2025] Директор департамента разработки // Цифровая Индустриальная Платформа
<!-- management -->
...
1. Придумал реальное содержание концепции «приложений на платформе ZIIoT» и создал процесс арх. надзора за приложениями (удешевило разработку и ускорило  развертывание)
<!-- tech -->
...
<!-- management -->
3. Превратил единый отдел разработки в независимые продуктовые команды.
<!--end-->
4. Собрал воедино хаотично связанные компоненты в единую систему
5. Получил полный контроль над происходящим на проде (исключил ручную выкладку и отобрал у разработки доступ к проду)
